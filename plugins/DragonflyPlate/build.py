...
PLUGIN_NAME = "DragonflyPlate"
PLUGIN_CODE = "DPlt"
MANUFACTURER_CODE = "Awin"
AU_COMPONENT = BUILD_DIR / f"plugins/{PLUGIN_NAME}/{PLUGIN_NAME}_artefacts/Release/AU/Dragonfly Plate.component"
STANDALONE_APP = BUILD_DIR / f"plugins/{PLUGIN_NAME}/{PLUGIN_NAME}_artefacts/Release/Standalone/Dragonfly Plate.app"
...
def do_build(standalone_only=False, au_only=False):
    ...
    run(["cmake", "-B", str(BUILD_DIR),
         ...
         "-DAPC_BUILD_ONLY_DRAGONFLY_PLATE=ON",
         "-DAPC_BUILD_ONLY_DRAGONFLY_HALL=OFF"],
        cwd=str(ROOT))
...
def main():
    parser = argparse.ArgumentParser(description="Build/install/validate Dragonfly Plate")
