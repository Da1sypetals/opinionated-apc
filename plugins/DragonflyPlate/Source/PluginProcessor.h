...
class DragonflyPlateAudioProcessor : public juce::AudioProcessor
{
public:
    DragonflyPlateAudioProcessor();
    ~DragonflyPlateAudioProcessor() override;
    ...
    static constexpr int NUM_PARAMS = 9;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (DragonflyPlateAudioProcessor)
};
